...
//=== Context ==================================================================
    ...
    Factory<v8::Context>::New(v8::ExtensionConfiguration * extensions,
                              v8::Local < v8::ObjectTemplate > tmpl, v8::Local < v8::Value > obj) {
...
//=== Function =================================================================
    ...
    Factory<v8::Function>::New(FunctionCallback callback, v8::Local <v8::Value> data) {
        ...
        return scope.Escape(v8::Function::New(isolate, imp::FunctionCallbackWrapper, obj));
    }

//=== Function Template ========================================================

    Factory<v8::FunctionTemplate>::return_t
    Factory<v8::FunctionTemplate>::New(FunctionCallback callback, v8::Local <v8::Value> data,
        ...
        if (callback) {
            ...
            return scope.Escape(
                    v8::FunctionTemplate::New(isolate, imp::FunctionCallbackWrapper, obj,
                                              signature));
        } else {
...
//=== Number Object ============================================================
    ...
    Factory<v8::NumberObject>::New(double value) {
        return v8::NumberObject::New(v8::Isolate::GetCurrent(), value).As<v8::NumberObject>();
    }
...
Factory<v8::RegExp>::New(
  ...
  return v8::RegExp::New(GetCurrentContext(), pattern, flags);
    ...
    Factory<v8::RegExp>::return_t
            Factory<v8::RegExp>::New(
            v8::Local < v8::String > pattern, v8::RegExp::Flags
    flags) {
    return
    Factory<v8::RegExp>::return_t(v8::RegExp::New(pattern, flags));
}
#endif
...
Factory<v8::Script>::return_t
        Factory<v8::Script>::New(v8::Local < v8::String > source, v8::ScriptOrigin const
& origin) {
v8::ScriptCompiler::Source src(source, origin);
return
Factory<v8::Script>::return_t(
...
Factory<v8::Signature>::return_t
        Factory<v8::Signature>::New(Factory<v8::Signature>::FTH
receiver) {
return

v8::Signature::New(v8::Isolate::GetCurrent(), receiver
...
Factory<v8::String>::New(const char *value, int length) {
    return Factory<v8::String>::return_t(
            v8::String::NewFromUtf8(
                    v8::Isolate::GetCurrent(), value, v8::String::kNormalString, length));
}

Factory<v8::String>::return_t
        Factory<v8::String>::New(
        std::string const
& value) /* NOLINT(build/include_what_you_use) */ {
assert(value
.
...
Factory<v8::String>::return_t(
        v8::String::NewFromUtf8(
        v8::Isolate::GetCurrent(), value.data(), v8::String::kNormalString,
...
Factory<v8::UnboundScript>::return_t
        Factory<v8::UnboundScript>::New(v8::Local < v8::String > source, v8::ScriptOrigin const
& origin) {
v8::ScriptCompiler::Source src(source, origin);
return
Factory<v8::UnboundScript>::return_t(
