...
public:
    ...
    WeakCallbackInfo(
            Persistent <v8::Value> *persistent, Callback callback, void *parameter,
            void *field1 = 0, void *field2 = 0) :
    ...
    NAN_INLINE v8::Isolate
    *

    GetIsolate() const { return isolate_; }

    NAN_INLINE T
    *

    GetParameter() const { return static_cast<T *>(parameter_); }
...
private:
    ...
    template<typename S, typename M> friend
    class Persistent;
...
NAN_INLINE void PersistentBase<T>::SetWeak(
        P *parameter, typename WeakCallbackInfo<P>::Callback callback, WeakCallbackType type) {
    WeakCallbackInfo<P> *wcbd;
    if (type == WeakCallbackType::kParameter) {
        wcbd = new WeakCallbackInfo<P>(
                reinterpret_cast<Persistent <v8::Value> *>(this), callback, parameter);
        ...
        wcbd = new WeakCallbackInfo<P>(
                reinterpret_cast<Persistent <v8::Value> *>(this), callback, 0, internal_fields[0],
                internal_fields[1]);
        persistent.MakeWeak(wcbd, WeakCallbackInfo<P>::invoke);
    }
}
