...
//=== Function =================================================================
    ...
    Factory<v8::Function>::New(FunctionCallback callback, v8::Local <v8::Value> data) {
        return Factory<v8::FunctionTemplate>::New(callback, data, v8::Local<v8::Signature>()
        )->GetFunction();
    }
    ...
    Factory<v8::FunctionTemplate>::New(FunctionCallback callback, v8::Local <v8::Value> data,
        ...
        if (callback) {
            ...
            obj->SetInternalField(
                    imp::kFunctionIndex, v8::External::New(reinterpret_cast<void *>(callback)));
            ...
            return scope.Close(
                    v8::FunctionTemplate::New(imp::FunctionCallbackWrapper, obj, signature));
        } else {
