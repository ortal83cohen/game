...
NAN_INLINE void SetTemplate(
        v8::Local < v8::Template > templ, const
char *name
, v8::Local<v8::Data>
value) {
templ->
...
NAN_INLINE void SetTemplate(
        v8::Local < v8::Template > templ, v8::Local < v8::String > name,
        v8::Local < v8::Data > value, v8::PropertyAttribute
attributes) {
templ->
...
NAN_INLINE void *GetInternalFieldPointer(
        v8::Local < v8::Object > object, int
index) {
return object->
GetPointerFromInternalField(index);
}
...
NAN_INLINE void AddGCEpilogueCallback(
        v8::GCEpilogueCallback callback, v8::GCType gc_type_filter = v8::kGCTypeAll) {
...
NAN_INLINE void AddGCPrologueCallback(
        v8::GCPrologueCallback callback, v8::GCType gc_type_filter = v8::kGCTypeAll) {
...
NAN_INLINE MaybeLocal<v8::Object> NewBuffer(
        char *data, size_t length, node::Buffer::free_callback callback, void *hint
) {
    EscapableHandleScope scope;
    // arbitrary buffer lengths requires
    // NODE_MODULE_VERSION >= IOJS_3_0_MODULE_VERSION
...
namespace imp {
    NAN_INLINE void
            widenString(std::vector < uint16_t > *ws, const
    uint8_t *s,
    int l
    ) {
...
NAN_INLINE MaybeLocal<BoundScript> CompileScript(
        v8::Local < v8::String > s, const
v8::ScriptOrigin &origin
) {
return
MaybeLocal<BoundScript>(
...
NAN_INLINE v8::Local <v8::Value> MakeCallback(
        v8::Local < v8::Object > target, v8::Local < v8::Function > func, int
argc
,
v8::Local <v8::Value> *argv
) {
return
New(node::MakeCallback(target, func, argc, argv));
}

NAN_INLINE v8::Local <v8::Value> MakeCallback(
        v8::Local < v8::Object > target, v8::Local < v8::String > symbol, int
argc
,
v8::Local <v8::Value> *argv
) {
return
New(node::MakeCallback(target, symbol, argc, argv));
}
...
* argv) {
return
New(node::MakeCallback(target, method, argc, argv));
}
...
NAN_INLINE v8::Local <v8::Value> ErrnoException(
        int errorno, const char *syscall = NULL, const char *message = NULL,
        const char *path = NULL) {
...
public:
    ...
    NAN_INLINE v8::Local <v8::Value> operator()(
            v8::Local <v8::Object> target, int argc = 0, v8::Local <v8::Value> argv[] = 0) const {
        return this->Call(target, argc, argv);
    }

    NAN_INLINE v8::Local <v8::Value> operator()(
            int argc = 0, v8::Local <v8::Value> argv[] = 0) const {
    ...
    Call(v8::Local <v8::Object> target, int argc, v8::Local <v8::Value> argv[]) const {
#if (NODE_MODULE_VERSION > NODE_0_10_MODULE_VERSION)
...
private:
  ...
  # endif
    ...
    v8::Local <v8::Value> Call_(v8::Local <v8::Object> target, int argc,
                                v8::Local <v8::Value> argv[]) const {
        EscapableHandleScope scope;
...
public:
    explicit AsyncProgressWorker(Callback *callback_)
        ...
        uv_async_init(
                uv_default_loop(), async, AsyncProgress_
        );
        async->data = this;
...
NAN_INLINE void AsyncQueueWorker(AsyncWorker *worker) {
    uv_queue_work(
            uv_default_loop(), &worker->request, AsyncExecute,
...
if (encoding == BUFFER) {
return
node::DecodeBytes(val, node::BINARY
);
}
# endif
return
node::DecodeBytes(val,
static_cast
...
NAN_INLINE ssize_t DecodeWrite(
        char *buf, size_t len, v8::Local <v8::Value> val, enum Encoding encoding = BINARY) {
#if (NODE_MODULE_VERSION > NODE_0_10_MODULE_VERSION)
...
# endif
    return node::DecodeWrite(
            buf, len, val, static_cast<node::encoding>(encoding));
#endif
}
...
PrototypeTemplate(), name, value

);
}

NAN_INLINE void SetPrototypeTemplate(
        v8::Local < v8::FunctionTemplate > templ, v8::Local < v8::String > name,
        v8::Local < v8::Data > value, v8::PropertyAttribute
attributes
) {
SetTemplate(templ
...
PrototypeTemplate(), name, value, attributes
...
InstanceTemplate(), name, value, attributes
...
NAN_INLINE void SetMethod(
        const T &recv, const char *name, FunctionCallback callback) {
    HandleScope scope;
...
NAN_INLINE void SetPrototypeMethod(
        v8::Local < v8::FunctionTemplate > recv, const
char *name, FunctionCallback
callback) {
HandleScope scope;
v8::Local <v8::Function> fn = GetFunction(New<v8::FunctionTemplate>(
        callback, v8::Local<v8::Value>(), New<v8::Signature>(recv))).ToLocalChecked();
v8::Local <v8::String> fn_name = New(name).ToLocalChecked();
recv->

PrototypeTemplate() -> Set(fn_name, fn);
...
inline void SetAccessor(
        v8::Local < v8::ObjectTemplate > tpl, v8::Local < v8::String > name, GetterCallback
getter
,
...
otpl->
SetInternalFieldCount(imp::kAccessorFieldCount);
...
obj->
SetInternalField(imp::kDataIndex, data
);
}
...
inline bool SetAccessor(
        v8::Local < v8::Object > obj, v8::Local < v8::String > name, GetterCallback
getter
,
SetterCallback setter = 0
, v8::Local<v8::Value>
...
inline void SetNamedPropertyHandler(
        v8::Local < v8::ObjectTemplate > tpl, PropertyGetterCallback
getter
,
...
v8::Local <v8::ObjectTemplate> otpl = New < v8::ObjectTemplate > ();
otpl->
SetInternalFieldCount(imp::kPropertyFieldCount);
v8::Local <v8::Object> obj = NewInstance(otpl).ToLocalChecked();
obj->
SetInternalField(
...
inline void SetIndexedPropertyHandler(
        v8::Local < v8::ObjectTemplate > tpl, IndexGetterCallback
getter
,
...
v8::Local <v8::ObjectTemplate> otpl = New < v8::ObjectTemplate > ();
otpl->
SetInternalFieldCount(imp::kIndexPropertyFieldCount);
v8::Local <v8::Object> obj = NewInstance(otpl).ToLocalChecked();
obj->
SetInternalField(
...
inline void SetCallHandler(
        v8::Local < v8::FunctionTemplate > tpl, FunctionCallback
callback
,
...
v8::Local <v8::ObjectTemplate> otpl = New < v8::ObjectTemplate > ();
otpl->
SetInternalFieldCount(imp::kFunctionFieldCount);
v8::Local <v8::Object> obj = NewInstance(otpl).ToLocalChecked();
...
tpl->
SetCallHandler(imp::FunctionCallbackWrapper, obj
);
}
...
tpl->
SetCallAsFunctionHandler(imp::FunctionCallbackWrapper, obj
);
}
